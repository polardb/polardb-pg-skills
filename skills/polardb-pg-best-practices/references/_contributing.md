# Writing Guidelines for PolarDB PostgreSQL References

This document provides guidelines for creating effective PolarDB PostgreSQL best
...
```markdown
Reference:
[PolarDB PostgreSQL Indexes](https://www.postgresql.org/docs/current/indexes.html)
```
