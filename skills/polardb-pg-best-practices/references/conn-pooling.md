...
PolarDB PostgreSQL connections are expensive (1-3MB RAM each). Without pooling, applications exhaust connections under load.
...
Reference: [Connection Pooling](https://www.pgbouncer.org/)
